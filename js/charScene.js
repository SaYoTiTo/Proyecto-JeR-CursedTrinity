export default class CharScene extends Phaser.Scene{
    ...
    create(){
            ...
            //Jugador
            this.arrow = this.physics.add.sprite(150,200,'arrow').setScale(0.1).refreshBody();
            this.blade = this.physics.add.sprite(245,200,'blade').setScale(0.07).refreshBody();
            this.cauldron = this.physics.add.sprite(200,100,'cauldron').setScale(0.1).refreshBody();

            //Oscurecer personajes
            this.arrow.setInteractive();
            this.blade.setInteractive();
            this.cauldron.setInteractive();        
            this.arrow.alpha = this.blade.alpha = this.cauldron.alpha = 0.5;
    ...
    update(){
            ...
            //Si haces click se mantiene encendido y se enciende el fondo
