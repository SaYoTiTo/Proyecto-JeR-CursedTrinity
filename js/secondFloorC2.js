...
export default class SecondFloorC2 extends BaseGame {
    constructor(){
        super('SecondFloorC2');
    }
    ...
    create(){
        ...
        super.setCurrentScene('SecondFloorC2');
        console.log(this.arrows);
        super.restartPos();
        super.resetLevers();
        super.resetRocks();
        if(this.registry.get('2C2') === false){
    ...
    update(){
        ...
        if(posX < 0.5){
            ...
            this.registry.set('2C2', true);
            this.scene.stop('SecondFloorC2');
