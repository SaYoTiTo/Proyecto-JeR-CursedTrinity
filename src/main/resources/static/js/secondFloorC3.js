...
export default class SecondFloorC3 extends BaseGame {
    constructor(){
        super('SecondFloorC3');
    }
    ...
    create(){
        ...
        super.setCurrentScene('SecondFloorC3');

        super.restartPos();
        super.resetLevers();
        super.resetRocks();
        if(this.registry.get('2C3') === false){
    ...
    update(){
        ...
        if(posY < 0.5){
            ...
            this.registry.set('2C3', true);
            this.scene.stop('SecondFloorC3');
            this.scene.start('SecondFloorC2', 
                             { lifeA: super.getHeroALifes(), lifeC: super.getHeroCLifes(), arrows: super.getArrows(), exitX: 0.5, exitY: 0 });//0.5,1
        }
