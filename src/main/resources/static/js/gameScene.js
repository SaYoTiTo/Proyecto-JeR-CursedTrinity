...
export default class GameScene extends Phaser.Scene{
    ...
    create() {
        ...
        this.keys = this.input.keyboard.addKeys(
            {up:Phaser.Input.Keyboard.KeyCodes.W,
             ...
             space3:Phaser.Input.Keyboard.KeyCodes.N}, false);            
    ...
    update() {
        if(document.readyState === 'complete'){
            ...
            this.input.on('gameout', this.handler);
			this.input.on('gameover', this.handler2);
...
function chat(){
    if(mouseOut!=true){
        music2.stop();
        this.scene.pause();
        this.scene.launch('ChatScene', { prev: 'GameScene'});
    }
}